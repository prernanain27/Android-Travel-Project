...
public class FinalProject extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ImageView oimageplane=(ImageView)findViewById(R.id.imageplane);
        Animation obj2=AnimationUtils.loadAnimation(getApplicationContext(), R.anim.tr1);
        
        oimageplane.setAnimation(obj2);
